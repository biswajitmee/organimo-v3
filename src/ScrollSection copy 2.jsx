...
import MountainSide from './component/underwater/MountainSide.jsx'
...
function Scene ({ sheet, guiFadeDefaults = {} }) {
      ...
      if (u >= 1) {
        ...
        if (
          ...
          const exitAllowed =
            ...
            (sessionDir === 'up' && (guiFadeDefaults.upExitEnabled ?? window._springFadeDefaults?.upExitEnabled ?? true))
 ...
 <e.group theatreKey='Cloud-front-New' position={[0, 0, 1]}>
  ...
  {/* <e.group theatreKey='MountainSide' position={[0, 0, 1]}>
 <MountainSide
            // geometry
            width={12}
            height={28}
            ...
            depth={1.2}
            repeat={[4, 8]}
            // IMPORTANT: pass correct prop names expected by MountainSide
            colorTextureURL={colorTexture}
            displacementURL={displacementTexture}
